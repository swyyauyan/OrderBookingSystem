    ...
    it("Step 0: Get order overview.", (done) => {
      ...
      it("Step 2: Get Order overview.", (done) => {
        ...
        .end((err, res) => {
          ...
          res.should.have.status(200);
        //   should.equal(res.body.lstPrc, 120);//TODO Bid market order
        //   should.equal(res.body.lstVol, 300);//false
          should.not.equal(res.body.lstTime, '');
          should.equal(res.body.totalVol, 300);
        //   should.equal(res.body.high, 120); //TODO Bid market order
        //   should.equal(res.body.low, 0); //TODO ask market order
